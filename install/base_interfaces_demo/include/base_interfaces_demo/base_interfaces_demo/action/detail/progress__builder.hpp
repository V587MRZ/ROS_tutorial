...
class Init_Progress_Result_sun
{
public:
  Init_Progress_Result_sun()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::base_interfaces_demo::action::Progress_Result sun(::base_interfaces_demo::action::Progress_Result::_sun_type arg)
  {
    msg_.sun = std::move(arg);
    return std::move(msg_);
  }
...
{
  return base_interfaces_demo::action::builder::Init_Progress_Result_sun();
}
