  ...
  size_t current_alignment)
{
  ...
  // Member: sun
  {
    size_t item_size = sizeof(ros_message.sun);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
bool cdr_serialize(
  const base_interfaces_demo::action::Progress_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const base_interfaces_demo::action::Progress_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const base_interfaces_demo::action::Progress_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
